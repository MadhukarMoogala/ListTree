        ...
        internal static async void _3leggedAsyncWaitForCode(IAsyncResult ar)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(code))
                {
                    ...
                    Autodesk.Forge.Client.ApiResponse<dynamic> bearer = await _threeLeggedApi.GettokenAsyncWithHttpInfo(config.ClientId, config.ClientSecret, oAuthConstants.AUTHORIZATION_CODE, code, FORGE_CALLBACK);
